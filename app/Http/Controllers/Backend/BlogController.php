...
class BlogController extends Controller
{
    ...
    {
        return view('backend.blog.category.blog_categroy_add');
    } // End Method
    ...
    public function EditBlogCateogry($id)
    {
        ...
        return view('backend.blog.category.blog_category_edit', compact('blogcategoryies'));
    } // End Method
    ...
    public function BlogPostCategory($id, $slug)
    {
        ...
        $blogcategories = BlogCategory::latest()->get();
        $breadcat = BlogCategory::where('id', $id)->get();
        return view('frontend.blog.category_post', compact('blogpost', 'blogcategories', 'breadcat'));
    } // End Method

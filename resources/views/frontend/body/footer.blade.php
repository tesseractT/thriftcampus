                ...
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        <div class="newsletter-content">
                            ...
                            <p class="mb-45">Start You'r Daily Shopping with <span class="text-brand">Thrift
                                    Campus</span></p>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                    ...
                    <ul class="contact-infor">
                        ...
                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-clock.svg') }}"
                                alt="" /><strong>Hours:</strong><span>{{ $setting->open_hours }}</span>
                        </li>
                    </ul>
                </div>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">&copy; 2023, <strong class="text-brand">Thrift Campus</strong>
                    {{ $setting->copyright }}</p>
            </div>

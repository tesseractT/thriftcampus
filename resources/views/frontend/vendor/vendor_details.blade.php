...
@section('main')
@section('title')
    Thrift Campus E-Stores | Vendor Details
@endsection
            ...
            <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                ...
                <div class="vendor-info">
                    ...
                    <h4 class="mb-5"><a href="{{ route('vendor.details', $vendor->id) }}"
                            class="text-heading">{{ $vendor->name }}</a>
                    </h4>
                    ...
                    <div class="vendor-info">
                        ...
                        <a href="{{ route('vendor.details', $vendor->id) }}" class="btn btn-xs">Contact Seller <i

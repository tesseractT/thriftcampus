...
@section('main')
@section('title')
    Thrift Campus E-Stores | {{ $product->product_name }}
@endsection
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            @if ($product->vendor_id == null)
                                <span class="font-small text-muted">Sold By <a href="vendor-details-1.html">Thrift
                                        Campus</a></span>
                            @else
                            ...
                            <div class="font-xs">
                                ...
                                <ul class="float-start">
                                    ...
                                    <li class="mb-5">Tags: <a href="#"
                                            rel="tag">{{ $product->product_tags }}</a>
                                    </li>
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                <div class="vendor-logo d-flex mb-30">
                                    ...
                                    <div class="vendor-name ml-15">
                                        @if ($product->vendor_id == null)
                                            <h6>
                                                <a href="vendor-details-2.html">Thrift Campus</a>
                                            </h6>
                                        @else
                                            <h6>
                                ...
                                @if ($product->vendor_id == null)
                                    <ul class="contact-infor mb-50">
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}"
                                            ...
                                            <span>Thrift Campus</span>
                                        </li>
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}"
                                                alt="" /><strong>Contact
                                                Seller:</strong><span> Thrift Campus</span></li>
                                    </ul>
                                @else
                                    <ul class="contact-infor mb-50">
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-location.svg') }}"
                                ...
                                <div class="comments-area">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="#" class="font-xs text-muted">How
                                                are ratings
                                                calculated?</a>
                                        </div>
                                    </div>

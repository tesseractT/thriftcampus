...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend/assets/imgs/theme/thriftcampus.png') }}" />
    <!-- Template CSS -->
...
<body>
    ...
    <script type="text/javascript">
        ...
        /// Start Add To Cart Prodcut Details
        ...
        /// End Add To Cart Prodcut Details
    </script>
                        ...
                        rows += `<tr class="pt-30">
                                ...
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading"
                                            href="shop-product-right.html">${value.name}</a>
                                    </h6>
                                </td>
                                <td class="price" data-title="Price">
                                ...
                                <td class="action text-center" data-title="Remove"><a type="submit" class="text-body " id="${value.rowId}" onclick="cartRemove(this.id)"><i

...
@section('vendor')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr />
                <form id="myForm" action="{{ route('vendor.update.product') }}" method="post">
                    @csrf
                            ...
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="short_desc" class="form-control" id="inputProductDescription" rows="3">{!! $products->short_desc !!}</textarea>
                                    </div>
    ...
    <div class="page-content">
        <h6 class="mb-0 text-uppercase">Update Thumbanail</h6>
        <hr>
        <div class="card">
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table mb-0 table-strped">
                    <thead>
                        <tr>
                            <th scope="col">
                                S/N
                    ...
                    <tbody>
                        <form action="{{ route('vendor.update.product.multi_image') }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            @foreach ($multiImgs as $key => $image)
                                <tr>
                                    <th scope="row">{{ $key + 1 }}</th>
                                    <th><img src="{{ asset($image->photo_name) }}" alt=""
                                            style="width: 70px; height:40px"></th>
                                    <th><input type="file" class="form-group" name="multi_img[{{ $image->id }}]">

                                    </th>
                                    <th>
                                        <input type="submit" class="btn btn-primary px-4" value="Update" />

                                        <a href="{{ route('vendor.product.multi_image.delete', $image->id) }}"

    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>THRIFT CAMPUS</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Jakande Lekki, Lagos Nigeria
               support@thriftcampus.com<br>
               1245454545 <br>
               Lagos Nigeria <br>
        ...
        <tr>
            <td>
                <p class="font" style="margin-left: 20px;">
                    ...
                    @endphp
                    <strong>Address:</strong> {{ $order->adress }} / {{ $div }} / {{ $dis }}<br>
